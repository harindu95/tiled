...
typedef struct {
    PyObject_HEAD
    Python::PythonTilesetFormatScript *obj;
    PyObject *inst_dict;
    PyBindGenWrapperFlags flags:8;
} PyPythonPythonTilesetFormatScript;


extern PyTypeObject PyPythonPythonTilesetFormatScript_Type;
...
static int
_wrap_PyPythonPythonTilesetFormatScript__tp_init(void)
{
    PyErr_SetString(PyExc_TypeError, "class 'PythonTilesetFormatScript' cannot be constructed ()");
    return -1;
}

static PyMethodDef PyPythonPythonTilesetFormatScript_methods[] = {
    {NULL, NULL, 0, NULL}
};

static void
PyPythonPythonTilesetFormatScript__tp_clear(PyPythonPythonTilesetFormatScript *self)
{
    Py_CLEAR(self->inst_dict);
        Python::PythonTilesetFormatScript *tmp = self->obj;
    self->obj = NULL;
    if (!(self->flags&PYBINDGEN_WRAPPER_FLAG_OBJECT_NOT_OWNED)) {
        delete tmp;
    }
...
static int
PyPythonPythonTilesetFormatScript__tp_traverse(PyPythonPythonTilesetFormatScript *self, visitproc visit, void *arg)
{
    Py_VISIT(self->inst_dict);
...
static void
_wrap_PyPythonPythonTilesetFormatScript__tp_dealloc(PyPythonPythonTilesetFormatScript *self)
{
    PyPythonPythonTilesetFormatScript__tp_clear(self);
    Py_TYPE(self)->tp_free((PyObject*)self);
}

static PyObject*
_wrap_PyPythonPythonTilesetFormatScript__tp_richcompare (PyPythonPythonTilesetFormatScript *PYBINDGEN_UNUSED(self), PyPythonPythonTilesetFormatScript *other, int opid)
{

    if (!PyObject_IsInstance((PyObject*) other, (PyObject*) &PyPythonPythonTilesetFormatScript_Type)) {
        Py_INCREF(Py_NotImplemented);
        return Py_NotImplemented;
    }
    switch (opid)
...
PyTypeObject PyPythonPythonTilesetFormatScript_Type = {
    PyVarObject_HEAD_INIT(NULL, 0)
    (char *) "tiled.PythonTilesetFormatScript",            /* tp_name */
    sizeof(PyPythonPythonTilesetFormatScript),                  /* tp_basicsize */
    0,                                 /* tp_itemsize */
    /* methods */
    (destructor)_wrap_PyPythonPythonTilesetFormatScript__tp_dealloc,        /* tp_dealloc */
    (printfunc)0,                      /* tp_print */
    (getattrfunc)NULL,       /* tp_getattr */
    (setattrfunc)NULL,       /* tp_setattr */
    (cmpfunc)NULL,           /* tp_compare */
    ...
    Py_TPFLAGS_BASETYPE|Py_TPFLAGS_DEFAULT|Py_TPFLAGS_HAVE_GC,                      /* tp_flags */
    NULL,                        /* Documentation string */
    (traverseproc)PyPythonPythonTilesetFormatScript__tp_traverse,     /* tp_traverse */
    (inquiry)PyPythonPythonTilesetFormatScript__tp_clear,             /* tp_clear */
    (richcmpfunc)_wrap_PyPythonPythonTilesetFormatScript__tp_richcompare,   /* tp_richcompare */
    0,             /* tp_weaklistoffset */
    (getiterfunc)NULL,          /* tp_iter */
    (iternextfunc)NULL,     /* tp_iternext */
    (struct PyMethodDef*)PyPythonPythonTilesetFormatScript_methods, /* tp_methods */
    (struct PyMemberDef*)0,              /* tp_members */
    0,                     /* tp_getset */
    NULL,                              /* tp_base */
    NULL,                              /* tp_dict */
    (descrgetfunc)NULL,    /* tp_descr_get */
    (descrsetfunc)NULL,    /* tp_descr_set */
    offsetof(PyPythonPythonTilesetFormatScript, inst_dict),                 /* tp_dictoffset */
    (initproc)_wrap_PyPythonPythonTilesetFormatScript__tp_init,             /* tp_init */
    (allocfunc)PyType_GenericAlloc,           /* tp_alloc */
    (newfunc)PyType_GenericNew,               /* tp_new */
    (freefunc)0,             /* tp_free */
    (inquiry)NULL,             /* tp_is_gc */
...
MOD_INIT(tiled)
{
    ...
    /* Register the 'Python::PythonTilesetFormatScript' class */
    if (PyType_Ready(&PyPythonPythonTilesetFormatScript_Type)) {
        return MOD_ERROR;
    }
    PyModule_AddObject(m, (char *) "TilesetFormat", (PyObject *) &PyPythonPythonTilesetFormatScript_Type);
...
int _wrap_convert_py2c__Tiled__Tileset___star__(PyObject *value, Tiled::Tileset * *address)
{
    PyObject *py_retval;
    PyTiledTileset *tmp_Tileset;
    
    py_retval = Py_BuildValue((char *) "(O)", value);
    if (!PyArg_ParseTuple(py_retval, (char *) "O!", &PyTiledTileset_Type, &tmp_Tileset)) {
        Py_DECREF(py_retval);
        return 0;
    }
    *address = new Tiled::Tileset(*tmp_Tileset->obj);
    Py_DECREF(py_retval);
    return 1;
}
...
PyObject* _wrap_convert_c2py__Tiled__Tileset_const(Tiled::Tileset const *cvalue)
{
    ...
    py_Tileset->obj = new Tiled::Tileset(*cvalue);
    py_retval = Py_BuildValue((char *) "N", py_Tileset);
    return py_retval;
}
